...
function Navegacao() {
  ...
  return (
    <Nav className="justify-content-center" id='navega' >
      ...
      <Nav.Item>
        <Nav.Link href="/jau/institucional" eventKey="link-1" style={{ color: 'black'}}> Institucional</Nav.Link>
      </Nav.Item>
      <NavDropdown title = "Planos" className= {styles['drop']}>
        <NavDropdown.Item href='/jau/planoFibra'>Fibra Óptica</NavDropdown.Item>
        <NavDropdown.Item href='/jau/planoTelecom'>Telecom</NavDropdown.Item>
      </NavDropdown>
      <Nav.Item>
