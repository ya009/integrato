  ...
  return (
      ...
      <div className= {styles['divNavegar']}>
        ...
        <Nav.Item className= {styles['navText']}>
          <Nav.Link  href="/palmeiropolis/institucional" eventKey="link-1"  > Institucional</Nav.Link>
        </Nav.Item>
        <Nav.Item className= {styles['navText']}>
        ...
        <Nav.Item className= {styles['navText']}>
          <Nav.Link eventKey="link-4" href='/palmeiropolis/RH'  style={{ color: 'black '}}> Trabalhe Conosco</Nav.Link>
        </Nav.Item>
        <Nav.Item >
